...
import ErbilCitadelTour from "../sours/imges/ErbilCitadelTour.webp";
import HamrinMountainTrek from "../sours/imges/HamrinMountainTrek.webp"; // أضف صورة هنا
import AbbasidBaghdad from "../sours/imges/AbbasidBaghdad.webp"; // أضف صورة هنا
...
const Card = () => {
  ...
  const tours = [
    ...
    },
    {
      ...
      image: AbbasidBaghdad, // Replace this with an actual image of Babylon if available
